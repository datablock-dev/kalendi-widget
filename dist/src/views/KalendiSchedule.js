...
export default function KalendiSchedule(_a) {
    ...
    return (_jsxs("div", __assign({ className: "h-[100%] w-[100%]" }, { children: [_jsxs("div", __assign({ className: "flex flex-row justify-between w-[100%] h-[40px] mb-[10px]" }, { children: [_jsxs("div", __assign({ className: "flex flex-row items-center gap-[6px] rounded-[3px] data-[selectable=true]:hover:cursor-pointer data-[selectable=false]:hover:cursor-not-allowed border-[#787878] border-[1px] border-solid px-[12px]", "data-selectable": weekMove > 0 ? true : false, onClick: function () { changeWeek('left'); } }, { children: [_jsx(KeyboardArrowLeftIcon, {}), " Previous Week"] })), _jsxs("div", __assign({ className: "flex flex-row items-center gap-[6px] rounded-[3px] data-[selectable=true]:hover:cursor-pointer data-[selectable=false]:hover:cursor-not-allowed data-[selectable=true]:hover:bg-[#d4d4d4] border-[#787878] border-[1px] border-solid px-[12px]", "data-selectable": weekMove < 10 ? true : false, onClick: function () { changeWeek('right'); } }, { children: ["Next Week ", _jsx(KeyboardArrowRightIcon, {})] }))] })), !weekView &&
                _jsx("div", __assign({ className: "w-[100%] h-[100%] flex justify-center items-center" }, { children: _jsx("div", __assign({ id: 'outer' }, { children: _jsx("div", __assign({ id: 'middle' }, { children: _jsx("div", { id: 'inner' }) })) })) })), _jsx("div", __assign({ className: "w-[100%] h-[50px] grid week-grid overflow-y-auto" }, { children: (weekView && userAvailability !== null) &&
                    weekView.map(function (day) {
                        return (_jsx("div", __assign({ className: "w-[100%] h-[100%] min-h-[100%] flex flex-col odd:bg-[#c4c4c48a]", "data-date": day.date.format('YYYY-MM-DD') }, { children: _jsxs("div", __assign({ className: "flex flex-col items-center" }, { children: [_jsx("span", { children: day.weekDayString.substring(0, 3) }), _jsx("span", { children: day.dayOfMonth })] })) }), day.date.format('YYYY-MM-DD HH:mm:ss')));
                    }) })), _jsx("div", __assign({ className: "w-[100%] h-[calc(100%_-_100px)] grid week-grid overflow-y-auto relative" }, { children: (weekView && userAvailability !== null) &&
                    weekView.map(function (day, index) {
                        ...
                        */
                        ...
                        return (_jsx("div", __assign({ className: "w-[100%] h-[100%] min-h-[100%] flex flex-col", "data-date": day.date.format('YYYY-MM-DD') }, { children: _jsxs("div", __assign({ className: "flex flex-col h-[100%] items-center gap-[10px] bg-[#fff] pt-[10px]" }, { children: [availableSlots.length > 0 &&
                                        availableSlots
                                            .filter(function (time) { return parseInt(time.substring(0, 2)) >= 7; })
                                            .map(function (time) {
                                            return (_jsx("div", __assign({ className: "rounded-[3px] bg-[#fff] py-[4px] px-[4px] border-solid border-[#d4d4d4] border-[1px] hover:cursor-pointer hover:bg-[#e4e4e4]", onClick: function () {
                                                ...
                                                } }, { children: _jsx("span", { children: time }) }), day.weekDayString + time));
                                        }), (!isNonBookable && availableSlots.length === 0 && !isBefore) &&
                                        _jsx("div", { children: _jsx("span", __assign({ className: "text-wrap" }, { children: "No available slots" })) }), (isNonBookable && index === 2 && !isBefore) &&
                                        _jsx("div", __assign({ className: "bg-[#1890ff] text-[#fff] px-[12px] py-[8px] rounded-[3px] border-[1px] hover:cursor-pointer hover:brightness-80 absolute bottom-[50%]" }, { children: _jsx("span", { children: "Next available time" }) })), isBefore &&
                                        _jsx("div", { className: "w-[calc(100%_-_2px)] h-[100%] bg-[repeating-linear-gradient(45deg,#606dbc,#606dbc_10px,#465298_10px,#465298_20px)] rounded-[3px]" })] })) }), day.date.format('YYYY-MM-DD HH:mm:ss')));
                    }) }))] })));
}
